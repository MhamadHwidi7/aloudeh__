...
@JsonSerializable()
class GetManifestWarehouseEntity {
  ...
  GetManifestWarehouseEntity({
    required this.success,
    required this.message,
    required this.data,
  });

  factory GetManifestWarehouseEntity.fromJson(Map<String, dynamic> json) =>
      _$GetManifestWarehouseEntityFromJson(json);

  Map<String, dynamic> toJson() => _$GetManifestWarehouseEntityToJson(this);
}
