...
GetManifestWarehouseEntity _$GetManifestWarehouseEntityFromJson(
...
Map<String, dynamic> _$GetManifestWarehouseEntityToJson(
        GetManifestWarehouseEntity instance) =>
    <String, dynamic>{
