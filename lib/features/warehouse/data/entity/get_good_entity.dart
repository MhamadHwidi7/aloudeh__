...
class GetGoodEntity {
  ...
  factory GetGoodEntity.fromJson(Map<String, dynamic> json) =>
      _$GetGoodEntityFromJson(json);

  Map<String, dynamic> toJson() => _$GetGoodEntityToJson(this);
}
