...
@JsonSerializable()
class GetTruckInformationSharedEntity {
  ...
  factory GetTruckInformationSharedEntity.fromJson(Map<String, dynamic> json) =>
      _$GetTruckInformationSharedEntityFromJson(json);

  Map<String, dynamic> toJson() => _$GetTruckInformationSharedEntityToJson(this);
}
