...
part 'active_trips_paginated_entity.g.dart';

@JsonSerializable()
class ActiveTripsPaginatedSharedEntity {
  @JsonKey(name: 'id')
  final int id;
  ...
  factory ActiveTripsPaginatedSharedEntity.fromJson(Map<String, dynamic> json) =>
      _$ActiveTripsPaginatedSharedEntityFromJson(json);

  Map<String, dynamic> toJson() => _$ActiveTripsPaginatedSharedEntityToJson(this);
}
