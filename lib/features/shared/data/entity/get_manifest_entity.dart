...
class GetManifestSharedEntity {
  ...
  factory GetManifestSharedEntity.fromJson(Map<String, dynamic> json) =>
      _$GetManifestSharedEntityFromJson(json);

  Map<String, dynamic> toJson() => _$GetManifestSharedEntityToJson(this);
}
