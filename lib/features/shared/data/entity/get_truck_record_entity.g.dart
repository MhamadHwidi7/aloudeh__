...
GetTruckRecordSharedEntity _$GetTruckRecordSharedEntityFromJson(
...
Map<String, dynamic> _$GetTruckRecordSharedEntityToJson(
        GetTruckRecordSharedEntity instance) =>
    <String, dynamic>{
