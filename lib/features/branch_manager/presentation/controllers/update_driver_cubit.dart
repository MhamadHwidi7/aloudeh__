...
@injectable
class UpdateDriverCubit extends Cubit<PostState<BaseEntity>> {
 final BranchManagerBaseRepository _branchManagerBaseRepository;
  ...
  Future<void> emitUpdateDriver({required UpdateDriverParams updateDriverParams}) async {
    emit(const PostState.loading());
    final response = await _branchManagerBaseRepository.updateDriver(updateDriverParams:updateDriverParams);
