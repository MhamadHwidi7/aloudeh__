...
@injectable
class GetCustomerByIdCubit extends Cubit<PostState<CustomerEmployeeEntity>> {
 final EmployeeBaseRepository _employeeBaseRepository;
  ...
  Future<void> emitGetCustomerById({required GetCustomerByIdParams getCustomerByIdParams}) async {
    ...
    final response = await _employeeBaseRepository.getCustomerById(getCustomerByIdParams);
