                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: BlocConsumer<LogInEmployeeCubit,
                              PostState<LogInEmployeeEntity>>(
                            listener: (context, state) {
                              state.whenOrNull(
                                success: (data) =>Navigator.pushReplacement(context,MaterialPageRoute(builder: (_)=> EmployeeMainScreen())) ,
                                ...
                                orElse: () => FloatingActionButton.extended(
                                  onPressed: () async {
                                    if (controller.formKey.currentState!
                                      ...
                                      context
                                          .read<LogInEmployeeCubit>()
                                          .emitLogInEmployee(
                                              logInEmployeeParams: LogInEmployeeParams(  name:
                                                          controller
                                                              .userNameController
                                                              .text,
                                                      password:
