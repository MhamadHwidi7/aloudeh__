...
class GetTruckRecordEntity {
  ...
  factory GetTruckRecordEntity.fromJson(Map<String, dynamic> json) =>
      _$GetTruckRecordEntityFromJson(json);

  Map<String, dynamic> toJson() => _$GetTruckRecordEntityToJson(this);
}
