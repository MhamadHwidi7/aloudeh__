...
@JsonSerializable()
class GetTripInformationEntity {
  ...
  factory GetTripInformationEntity.fromJson(Map<String, dynamic> json) =>
      _$GetTripInformationEntityFromJson(json);

  Map<String, dynamic> toJson() => _$GetTripInformationEntityToJson(this);
}
