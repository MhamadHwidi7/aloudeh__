...
@JsonSerializable()
class ArchiveTripsPaginatedEntity {
  @JsonKey(name: 'id')
  final int id;
  ...
  factory ArchiveTripsPaginatedEntity.fromJson(Map<String, dynamic> json) =>
      _$ArchiveTripsPaginatedEntityFromJson(json);

  Map<String, dynamic> toJson() => _$ArchiveTripsPaginatedEntityToJson(this);
}
