...
@JsonSerializable()
class ActiveTripsPaginatedEntity {
  @JsonKey(name: 'id')
  final int id;
  ...
  factory ActiveTripsPaginatedEntity.fromJson(Map<String, dynamic> json) =>
      _$ActiveTripsPaginatedEntityFromJson(json);

  Map<String, dynamic> toJson() => _$ActiveTripsPaginatedEntityToJson(this);
}
