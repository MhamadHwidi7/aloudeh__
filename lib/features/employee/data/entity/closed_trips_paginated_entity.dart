...
part 'closed_trips_paginated_entity.g.dart';

@JsonSerializable()
class ClosedTripsPaginatedEntity {
  @JsonKey(name: 'id')
  final int id;
  ...
  factory ClosedTripsPaginatedEntity.fromJson(Map<String, dynamic> json) =>
      _$ClosedTripsPaginatedEntityFromJson(json);

  Map<String, dynamic> toJson() => _$ClosedTripsPaginatedEntityToJson(this);
}
