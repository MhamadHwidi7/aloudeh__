...
abstract class Loading<T> implements PaginationState<T> {
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'PaginationState<$T>.success(data: $data, canLoadMore: $canLoadMore)';
  }
...
abstract class Success<T> implements PaginationState<T> {
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'PaginationState<$T>.error(networkExceptions: $networkExceptions)';
  }
